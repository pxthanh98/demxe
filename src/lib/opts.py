...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--val_demxe', default=False, help='val demxe')
    self.parser.add_argument('--test_demxe', default=False, help='test demxe')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/data/FairMOT/data')
